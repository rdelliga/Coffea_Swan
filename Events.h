...
// Tue Sep 19 18:55:18 2023 by ROOT version 6.24/08
// from TTree Events/Events
// found on file: WPHADWMLEPjj_4f_EWK.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           SubJet_hadronFlavour[11];   //[nSubJet]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("WPHADWMLEPjj_4f_EWK.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("WPHADWMLEPjj_4f_EWK.root");
      }
